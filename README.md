...
npx expo start
```
*Note: Using the **Expo Go** app on a physical device is recommended to experience the touch-friendly interactions and responsiveness firsthand.*

---

### 🛠️ Future Roadmap
Meaningful enhancements planned for future iterations:
* **Full Dark Mode Support**: (Currently Implementing) A system-wide theme toggle to provide a premium, low-light experience for nighttime financial tracking.
* **Biometric Lock**: Securing financial data via FaceID/TouchID.
* **Data Export**: CSV/PDF generation for tax and personal records.
